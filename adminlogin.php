...
<body>
    ...
    <a href="#" style="position: absolute; top:5%; right:9.5%;" class="btn btn-danger">Crew</a>
    ?>
        <div class="container">
...
if(isset($_POST['login'])){
  ...
  mysqli_select_db($connect, "adminlogin");
  
  $result = mysqli_query($connect, "select * from login where user='$username' and password = '$passw'");

  $res = mysqli_fetch_array($result);
  if($res['user'] == $username && $res['password'] == $passw){
    $_SESSION['check'] = 1;
    $up = false;
    header("location: http://localhost/php/admindeshbord.php");
  } else{
